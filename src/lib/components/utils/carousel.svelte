...
<div class="carousel">
	<div class="control-btn">
		<button class="ax-btn prev" on:click={prevImage}
			><ChevronLeft strokeWidth={$strokeWidth} /></button
		>
	</div>
	...
	<div class="control-btn">
		<button class="ax-btn next" on:click={nextImage}
			><ChevronRight strokeWidth={$strokeWidth} /></button
		>
	</div>
</div>
